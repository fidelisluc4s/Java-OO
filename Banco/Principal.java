...
public class Principal
{
    ...
    public static void realizarOperacoes(Banco b){
        //listar as contas //escolher uma conta
        ...
        if(leExt.next().equalsIgnoreCase("D")){
            System.out.println("### informe o valor da operaçao");
    ...
    public static Conta escolhaConta(ArrayList<Conta> contas){
        ...
        int i = 1;
        for(Conta c : contas){
            System.out.println("#"+(i++)+")"+c.getNumero()+"("+(c.getClass()+"").replaceAll("class","")+")");
        }
    ...
    public static void imprimeDados(Banco bco, ArrayList<Cliente> clientes){
        ...
        for(Cliente c: clientes){
            ...
            for(Conta cc: c.getMinhasContas() ){
                System.out.println("#### Conta "+cc.getNumero() +"("+c.getClass()+")");
    ...
    public static Conta criaConta(Banco bco, ArrayList<Cliente> clientes){
        ...
        Conta c;
        //c = (resp.equalsIgnoreCase("C"))? new Conta() :((resp.equalsIgnoreCase("P"))? new Poupanca():((resp.equalsIgnoreCase("E"));
        ...
        System.out.println("### Cliente ja cadastrados, escolha 1:");
    ...
    public static int montaMenu(Scanner le){
